...
class Tileset:
    ...
    def __init__(self, type, size=(8, 8), **kwargs):
        ...
        # define all texture files
        grass_tile = 'grass_tile.png'

        # load textures into dict

        cropped = (0, 0, 96, 96)
        surf = pygame.Surface((96, 96), pygame.SRCALPHA)
        cropped_texture = pygame.image.load(os.path.join(Tileset.dir, 'UI_elements.png')).subsurface(cropped)
        surf.blit(cropped_texture, (0, 0))

        cropped = (96, 0, 96, 32)
        surf2 = pygame.Surface((96, 32), pygame.SRCALPHA)
        cropped_texture = pygame.image.load(os.path.join(Tileset.dir, 'UI_elements.png')).subsurface(cropped)
        surf2.blit(cropped_texture, (0, 0))
        ...
        self.textures = {
            ...
            MENU: surf,
            MENUm: surf2,
            MENUc: pygame.image.load(os.path.join(Tileset.dir, 'canvas.png'))
        }
